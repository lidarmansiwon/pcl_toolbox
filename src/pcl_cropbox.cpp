...
private:
    ...
    {   
        declare_parameter<double>("crop_box_y_min", -2.4);
        declare_parameter<double>("crop_box_y_max", 2.4);
        declare_parameter<double>("crop_box_z_min", -0.25);
        declare_parameter<double>("crop_box_z_max", 0.5);
        declare_parameter<double>("crop_box_x_min", -2.3);
        declare_parameter<double>("crop_box_x_max", 2.0);
    }
